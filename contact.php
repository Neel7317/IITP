...
<head>
  ...
  <title>Contact Us | COE'S Bihar</title>
...
li a:hover {
  ...
  <footer class="page-footer">
    <div class="container">
      ...
      <p id="copyright">Copyright &copy; <script>document.write(new Date().getFullYear())
    </script> COEs Bihar <a href="https://www.iitp.ac.in/index.php/en-us/" target="_blank">IIT Patna</a>. All right reserved</p>
    </div>
  </footer>
